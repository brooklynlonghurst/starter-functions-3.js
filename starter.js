...
const colors = ['red', 'blue', 'yellow', 'green', 'orange']
 ...
 const mappedColors  = colors.map((colorString, index, array) => {
    return 'pink'
 })
...
const expenses = [ //elements in array are objects not just numbers
    {
        title: 'rent', 
        amount: 1000
    }, 
 ...
 const remaining  = expenses.reduce((acc, cur) =>{
    return acc - cur.amount //get the number out of the obeject with .amount
 }, budget) //dont forget the numeric starting value
